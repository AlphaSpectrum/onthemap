...
class PostViewController: UIViewController {
    ...
    @IBAction func postStudentLocation(_ sender: Any) {
        if (firstNameTextField.text?.isEmpty)! && (lastNameTextField.text?.isEmpty)! && (mediaURLTextField.text?.isEmpty)! {
            ...
            let student = Student(uniqueKey: "9482084", firstName: firstNameTextField.text!, lastName: lastNameTextField.text!, address: studentAddress, mediaURL: mediaURLTextField.text!)
    ...
    private func convertStudentStructToJSON(_ user: Student) -> String {
    ...
    private func postStudentData(_ student: Student) {
