...
class UConnectionClient: ConnectionManager {
    ...
    internal func createURLFromParameters(_ parameters: [String : AnyObject], withPathExtension: String? = nil) -> URL {
